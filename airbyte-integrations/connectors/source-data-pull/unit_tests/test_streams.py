...
import pytest
from source_data_pull.source import DataPullStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(DataPullStream, "path", "v0/example_endpoint")
    mocker.patch.object(DataPullStream, "primary_key", "test_primary_key")
    mocker.patch.object(DataPullStream, "__abstractmethods__", set())


def test_request_params(patch_base_class):
    stream = DataPullStream()
