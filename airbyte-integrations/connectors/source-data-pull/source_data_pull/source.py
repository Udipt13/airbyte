...
# class DataPullStream(HttpStream, ABC):
#     """
...
#     `class DataPullStream(HttpStream, ABC)` which is the current class
#     `class Customers(DataPullStream)` contains behavior to pull data for customers using v1/customers
#     `class Employees(DataPullStream)` contains behavior to pull data for employees using v1/employees

#     If some streams implement incremental sync, it is typical to create another class
#     `class IncrementalDataPullStream((DataPullStream), ABC)` then have concrete stream implementations extend it. An example
#     is provided below.
...
# class Customers(DataPullStream):
#     """
...
# class CsvData(HttpStream): # same name as given in schema
...
class ExchangeRates(HttpStream): # same name as given in schema
    ...
    def parse_response(
        ...
        my_bytes = response.encode('utf-8')
